...
class ApoderadoDAO
{
	...
	{	
		...
		$stid = oci_parse($this->conex, "SELECT * FROM FISC_APODERADO");
		if (!$stid){
	...
	**/
	...
	{	
		$this->conex = DataBase::getInstance();
		$stid = oci_parse($this->conex, "SELECT * FROM FISC_APODERADO WHERE ID_APODERADO=:id_ciu");
		if (!$stid){
			$e = oci_error($this->conex);
			trigger_error(htmlentities($e['message'], ENT_QUOTES), E_USER_ERROR);
		}
	...
	**/
	...
	{
		$this->conex = DataBase::getInstance();
		$stid = oci_parse($this->conex, "SELECT * FROM FISC_APODERADO WHERE ID_DENUNCIA=:id_den");
		if (!$stid){
			$e = oci_error($this->conex);
			trigger_error(htmlentities($e['message'], ENT_QUOTES), E_USER_ERROR);
		}
	...
	{
		$this->conex = DataBase::getInstance();
		$stid = oci_parse($this->conex, "SELECT * FROM FISC_APODERADO WHERE ID_EMPRESA=:id_emp");
		if (!$stid){
			$e = oci_error($this->conex);
			trigger_error(htmlentities($e['message'], ENT_QUOTES), E_USER_ERROR);
		}
	...
	**/
	...
	{
		$this->conex = DataBase::getInstance();
		$stid = oci_parse($this->conex, "SELECT count(*) as pepe FROM FISC_APODERADO WHERE ID_EMPRESA='$id' AND ID_CIUDADANO='$ced' AND ESTATUS_DENUNCIA=0 ");
		if (!$stid){
			$e = oci_error($this->conex);
			trigger_error(htmlentities($e['message'], ENT_QUOTES), E_USER_ERROR);
		}
	...
	{
		$this->conex = DataBase::getInstance();
		$stid = oci_parse($this->conex, "SELECT count(*) as estatus FROM FISC_APODERADO WHERE ESTATUS_DENUNCIA=:id_estatus");
		if (!$stid){
			$e = oci_error($this->conex);
			trigger_error(htmlentities($e['message'], ENT_QUOTES), E_USER_ERROR);
		}
	...
	{
		$this->conex = DataBase::getInstance();
		$consulta = "DELETE FROM FISC_APODERADO WHERE ID_DENUNCIA = :id_den";
	...
	**/
	public function actualizar(&$data)
	{
		...
		$this->conex = DataBase::getInstance();
		$stid = oci_parse($this->conex, "UPDATE FISC_APODERADO SET 
