    ...
    <article id='contenedor_mensajes'>
      <div class="container-fluid">
       <div class="row">
        ...
        <div class="col-md9">
         <span> <p style="margin-top: 20px;">Registro actualizado exitosamente! </p></span>
         ...
         <input type='button' class='btn btn-primary' style="display: block; margin:10px auto;" value='Finalizar' onclick="location='../quejas.php?ivss=c'" > 
       </div>
     </div>
   </div> 
...
<div id="content_pdf" style="position:fixed;top:0;left:0;width:100%;height:100%;display:none;background:rgba(0,0,0,0.5);">
  ...
  <div style="width:80%;height:100%;margin:auto;">
    <iframe id="pdf_denuncia" data-src="<?=$base_url;?>App/mod_denuncias/notificacion_cierre_queja.php?id_denuncia=<?=$id_denuncia?>" style="width:100%;height:100%;margin:auto;"></iframe>
  </div>  
</div>
<!--Ventana modal con el pdf-->
...
$(document).on("ready",function(){
    $("#imprimir").on("click",function(){
        window.location.href="../notificacion_cierre_queja.php?id_denuncia="+"<?php #echo $id_denuncia;?>";
    });
});
</script>
-->
