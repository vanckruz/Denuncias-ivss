    ...
    <table id="tabla_denuncias" class="table table-hover">
        <thead>
            <tr>
                ...
                <td class="fon_td">Nombre</td>
                <td class="fon_td">Cedula</td>
                <td class="fon_td">Descripcion</td>          
                <td class="fon_td">Fecha de la Denuncia</td>
                <td class="fon_td">Nombre de la Empresa</td>
                <td class="fon_td">N°Patronal</td>      
                <td class="fon_td">Status</td>      
                <td class="fon_td">Direcciones Generales</td>     
                <td class="fon_td">Motivo</td>      
            </tr>
        </thead>
        ...
        <tbody>
            ...
            <tr class="font_body" data-nacionalidad="" data-cedula="">    
                ...
                <td><?php echo  $key["DATOS_CIUDADANO"]; ?></td>
                <td><?php echo  $key["ID_CIUDADANO"]; ?></td>
                <td><?php echo  $key["DESCRIPCION"]; ?></td>
                <td><?php echo  $key["FECHA_DENUNCIA"]; ?></td>
                <td><?php echo  $key["NOMBRE_EMPRESA"]; ?></td>
                <td><?php echo  $key["ID_EMPRESA"]; ?></td>
                <td><?php echo  $key["ESTATUS_DENUNCIA"]; ?></td>
                <td><?php echo  $key["DIRECCIONES"]; ?></td>
                <td class="motclass"><?php echo  $key["MOTIVOS"]; ?></td>
        ...
        <tfoot style="display:none">
            <tr>
                ...
                <td class="fon_td">N°Patronal</td>      
                <td class="fon_td">Status</td>      
                <td class="fon_td">Direcciones Ge 
                </tr>
            </tfoot>
        </table>
...
<script>
    ...
    {
        //$.fn.dataTable.Buttons.swfPath = "http://desarrollofiscalizacion.ivss.int/public_html/vendor/DataTables/extensions/Buttons-1.0.0/swf/flashExport.swf";
...
$('#tabla_denuncias').dataTable( {
 ...
 //$('#example').dataTable( { "dom": 'T<"clear">lfrtip', "tableTools": { "sSwfPath": "/swf/copy_csv_xls_pdf.swf" } } ); 
