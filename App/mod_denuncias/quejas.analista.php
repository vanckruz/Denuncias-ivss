...
<body style="background:linear-gradient(to right, #AFA19E, #E7E7FF, #E7E7E7, #8E8E8E) no-repeat scroll 0% 0% #8E8E8E;height:auto;">
    <div class="content-menu">
        <a href="Views/forminsert_queja.php" name="registrar" id="registrarden" class="cambia_link" data-content="Esta opción permite registrar una queja con un identificador de persona juridica." rel="popover" data-placement="right" data-original-title="Registro de Quejas y/o Reclamos" data-trigger="hover" >
            <div class="item-menu">  
...
<?php /* ?>
        <a href="Views/gestionarDocumentos.php" name="doc_den" id="doc_den" class="cambia_link" data-content="Esta opción permite gestionar los documentos a consignar para registrar una queja." rel="popover" data-placement="right" data-original-title="Gestión de Documentos" data-trigger="hover">
            <div class="item-menu">  
        ...
        <a href="Views/gestionarMotivos.php" name="mot_den" id="mot_den" class="cambia_link" data-content="Esta opción permite gestionar los motivos de quejas" rel="popover" data-placement="right" data-original-title="Gestión de Motivos" data-trigger="hover">
            <div class="item-menu">  
