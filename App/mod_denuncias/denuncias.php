...
<body style="background:linear-gradient(to right, #AFA19E, #E7E7FF, #E7E7E7, #8E8E8E) no-repeat scroll 0% 0% #8E8E8E;height:auto;">
    <div class="content-menu">       
        ...
        <a href="Views/documentos_denuncia.php" name="doc_den" id="doc_den" class="cambia_link" data-original-title="Gestión de Documentos de Denuncias" data-content="Esta opción permite gestionar los documentos a consignar en el registro de denuncias" rel="popover" data-placement="right" data-trigger="hover">
            <div class="item-menu">
        ...
        <a href="Views/estadisticas_denuncias.php" name="est_den" id="est_den" class="cambia_link" data-original-title="Gestión de Estadisticas de Denuncias" data-content="Esta opción permite estudiar las estadisticas para las denunicias." rel="popover" data-placement="right" data-trigger="hover" >
            <div class="item-menu">
...
<script>
    $(document).ready(function()
    {
        ...
        $('#registrarden,#consultarden,#asignar_den,#reportes_den,#doc_den,#mot_den,#dir_den,#volver_act,#menu_principal,#est_den').popover({ trigger: "hover" });
