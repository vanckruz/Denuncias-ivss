...
$objPHPExcel = new PHPExcel();
		...
		$objPHPExcel->getProperties()->setCreator("Edwin Garcia") //Autor
							 ...
							 $titulosColumnas = array('QUEJA Y/O RECLAMOS','N° PATRONAL','NOMBRE DEL REPRESENTANTE','FECHA DENUNCIA','MOTIVOS','FECHA CIERRE'); 
       	...
       	*/
			...
			{	
				...
				foreach ($quejas as $key => $fila) 
				{
					...
					$nombre = dameNombreDenuncianteQueja($fila['ID_EMPRESA']);
