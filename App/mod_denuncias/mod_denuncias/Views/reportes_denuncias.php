...
$denuncias = dameDenunciasEspecificas();    
...
<body>
    <div id="panel_denuncias" style="width:100%;height:100%;padding:25px;background:white;margin-bottom:50px;">

        <div style="font-size:1.1em;color:#333;background:#3B5998;padding:5px;color:white;margin-top:12px;margin-bottom:12px;"><span class="glyphicon glyphicon-paste"></span> Reportes de Denuncias</div>

        <form action="<?=$base_url;?>App/mod_denuncias/Controllers/Controller.Reportes.php" method="POST" class="form-inline" id="form_reportes_denuncias"> 
            <table class="table table-hover">
                <tr>
                    <th style="text-align:left;font-size:0.9em;">Direcciones</th>
                    <td>
                        <select class="chosen" id="chosen_dir" name="direcciones[]" multiple="multiple" style="width:500px !important;float:left !important;">
                ...
                <tr>
                    ...
                    <td>
                        <select class="chosen" id="chosen_est" name="motivos[]" multiple="multiple" style="width:500px !important;float:left;">
                ...
                <tr>
                    ...
                    <td>
                        <select class="chosen" id="chosen_mot" name="status[]" multiple="multiple" style="width:500px !important;float:left;">
            ...
            <table class="table table-hover">
                ...
                <tr>
                    <td colspan="3">
                        <button type="submit" style="float:right;font-size:1em;padding:7px;" class="btn btn-primary" id="form_reportes_denuncias_boton"><span class="glyphicon glyphicon-search"></span> Filtrar</button>   
                    </td>
                </tr>
            </table>          
            ...
            <table id="tabla_denuncias" class="table table-hover" >
                ...
                <tbody class="tbody_list_den">
                    ...
                    <tr class="font_body2" data-nacionalidad="" data-cedula="">    
                        ...
                        <td class="td_espacio_mas2"><?php echo  $key["DATOS_CIUDADANO"]; ?></td>

                        <td class="td_espacio_mas3"><?php echo  $key["ID_CIUDADANO"]; ?></td>

                        <td class="td_espacio_mas4"><?php echo  $key["DESCRIPCION"]; ?></td>

                        <td class="td_espacio_mas5"><?php echo  $key["FECHA_DENUNCIA"]; ?></td>

                        <td class="td_espacio_mas6"><?php echo  $key["NOMBRE_EMPRESA"]; ?></td>

                        <td class="td_espacio_mas7"><?php echo  $key["ID_EMPRESA"]; ?></td>

                        <td class="td_espacio_mas8"><?php echo  $key["ESTATUS_DENUNCIA"]; ?></td>
        ...
        <form action="<?php $base_url; ?>Controllers/ControllerExcelDenuncia.php" method="POST" class="form-inline">
...
<div style='position:fixed; top:0; left:0;z-index:12;width:100%;height:100%;background:rgba(0,0,0,0.6); display: none;' id="mensaje">
    ...
    <div id="Cargando" style="display:none;position:fixed;z-index:100000;background:rgba(0,0,0,0.8);width:100%;height:100%;top:0;left:0;">
        <div id="error_msnced2" title="Mensaje" style="z-index:10;width:600px;hight:300px;margin:auto;margin-top:200px;background:rgba(255,255,255,0.8);" >
            ...
            <div class="mensaje_loading" style="padding:25px 25px 25px 25px;font-size:1.3em;background-color:white;">
                <img src='http://desarrollofiscalizacion.ivss.int/public_html/imagenes/484.GIF' style='width:150px;height:auto;opacity:1;'>
            </div>
        </div>
    </div>
    <!--******************************************************************************************-->
    ...
    <script>
        ...
        /******************************************************************/
        $("#form_reportes_denuncias_boton").on("click",function(e){
            e.preventDefault();
        ...
        {
            //console.log("fino");
            $("#tabla_denuncias").dataTable().fnDestroy();
            $.ajax({
                url:$("#form_reportes_denuncias").attr("action"),
                type:"post",
                dataType: "json",
                data:$("#form_reportes_denuncias").serialize(),
                beforeSend:function(){
                  $("#Cargando").fadeIn();
              },
              success:function(resp){
                $('#tabla_denuncias').html(resp.tabla);
