    ...
    <table id="tabla_denuncias" class="table table-hover">
        <thead>
            <tr>
                ...
                <td class="fon_td">N° Patronal/Rif</td>      
                <td class="fon_td">Estatus</td>
                <td class="fon_td">Detalles</td>          
                <td class="fon_td">Procesar</td>
            </tr>
        </thead>
        ...
        <tbody>
            ...
            <tr class="font_body" data-nacionalidad="" data-cedula="">    
                ...
                <td><?php echo  ( $key["ID_EMPRESA"] = "N/A" ? $key["RIF"] : $key["ID_EMPRESA"] ); ?></td>
                <td><?php 
                 switch ($key["ESTATUS_DENUNCIA"]) {
                    case 0:
                    $key["ESTATUS_DENUNCIA"] = "Procedente";
                    break;

                    case 1:
                    $key["ESTATUS_DENUNCIA"] = "No procedente";
                    break;

                    case 2:
                    $key["ESTATUS_DENUNCIA"] = "Cerrada";
                    break;                                                        

                    default:
                    $key["ESTATUS_DENUNCIA"] = "S/E";
                    break;
                }

                echo $key["ESTATUS_DENUNCIA"];
                ?>
            </td>
            ...
            <td><button class="btn btn-primary updateden" id="<?=$key["ID_DENUNCIA"]?>" title="Procesar" style="<?=( ($key["ESTATUS_DENUNCIA"] == 'Cerrada' || $key["ESTATUS_DENUNCIA"] == 'No procedente') ? 'display:none;' : 'display:block;' )?>"><span class="glyphicon glyphicon-pencil"></span></button></td>
        </tr>
        <?php }} ?>
    </tbody>
