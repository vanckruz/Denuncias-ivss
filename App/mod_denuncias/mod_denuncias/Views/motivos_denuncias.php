...
<head>
	...
	<link   href="../../../resources/jquery.confirm/jquery.confirm/jquery.confirm.css">
	<link   href="../../../public_html/vendor/jquery-ui/jquery-ui.min.css">
	<title>Registro de Motivos</title>

	<script  src="../../../public_html/js/jquery-2.1.4.min.js"></script>
	<script  src="../../../public_html/vendor/jquery-ui/jquery-ui.min.js"></script>
...
<body>
	...
	<div style="width:100%;margin:auto;margin-bottom:0px;background:transparent;color:white;padding:7px 0px 0px 0px;position:relative;border-bottom:1px dotted white;" id="titulo_gestor_motivos">
		<div style="background:#f1f1f1;border-bottom:1px dotted black;padding:7px;overflow:hidden">
			<h3 style="float:left;color:black;padding:7px;">Gestión de motivos de denuncia</h3>
			<button class="btn btn-primary" style="float:right;" id="btn_agregar_motivos"><span class="glyphicon glyphicon-plus-sign"></span> Agregar Motivos</button>
		</div>
	</div>
	<!--Contenedor motivos-->
		...
		<div style="width:100%;">
			...
			<table class="table table-hover" id="tabla_motivos">
				...
				foreach ($motivos as $motivo) {
					...
					<td>
						<button id="'.$motivo["ID_MOTIVO"].'" class="btn btn-primary mas_user edit_mot_denuncia" data-nombre_motivo="'.str_replace(" ","-",$motivo["DESCRIPCION"]).'">
							<span class="glyphicon glyphicon-pencil"></span>
						</button>
					</td>
					<td>
						<button id="'.$motivo["ID_MOTIVO"].'" class="btn btn-danger mas_user eliminar_mot_denuncia" data-nombre_motivo="'.str_replace(" ","-",$motivo["DESCRIPCION"]).'">
...
<div id="agregar_motivo" style="display:none;width:100%;height:100%;position:fixed;top:0px;left:0px;z-index:50;overflow:hidden;">
	<div style="width:100%;margin-bottom:25px;background:#3B5998;color:white;padding:26px;">
		<h1 style="text-align:center;">Agregar Motivos</h1>
	</div>	
	<div style="width:70%;margin:auto;height:auto;overflow:hidden;padding:25px;background:#f1f1f1;position:relative;">
		<form action="Controllers/Controller_Motivos_Denuncias.php" method="post" id="form_agregar_motivo">
			...
			<div id="input_agregador_motivos" style="margin-top:35px">
				...
				<input type="text" class="form-control inputivo input_agregar" style="border-radius:0px;" name="motivo[]"  maxlength="200">	
			</div>
			<hr>
			<div>
...
<div id="editar_motivo" style="display:none;width:100%;height:100%;position:fixed;top:0px;left:0px;z-index:50;overflow:hidden;">
	<div style="width:100%;margin-bottom:25px;background:#3B5998;color:white;padding:26px;">
		<h1 style="text-align:center;">Editar este Motivo</h1>
	...
	<div style="width:70%;margin:auto;height:250px;overflow:hidden;padding:25px;background:#f1f1f1;">
		<form action="Controllers/Controller_Motivos_Denuncias.php" method="post" id="form_editar_motivo">
			<p style="text-align:left;margin-bottom:12px;font-weight:bold;">Descripción del motivo:</p>
...
<div id="eliminar_motivo" style="display:none;width:100%;height:100%;position:fixed;top:0px;left:0px;z-index:50;overflow:hidden;">
	<div style="width:100%;margin-bottom:25px;background:#3B5998;color:white;padding:26px;">
		<h1 style="text-align:center;">Eliminar este Motivo</h1>
		<!--<span class="glyphicon glyphicon-remove-circle" style="float:right;font-size:1.6em;margin-bottom:21px;margin-right:21px;cursor:pointer;"></span>-->
	</div>	
	<div style="width:50%;margin:auto;height:200px;overflow:hidden;padding:25px;background:#f1f1f1;">
		<form action="Controllers/Controller_Motivos_Denuncias.php" method="post" id="form_eliminar_motivo">
			<p style="text-align:center;margin-bottom:12px;font-size:1.2em;font-weight:bold;">¿Desea eliminar este motivo?</p>
			<input type="hidden" name="option_eliminar" value="eliminar">
			<input type="hidden" name="eliminar_motivo" id="input_motivo_eliminar">
			<hr>
			<div>
...
/*
		...
		var motivo_edit = $("#input_motivo_edicion").val();

		$("#submit_editar").on("click",function(e){
			e.preventDefault();
			
			if( $("#input_motivo_edicion").val() == "" || $("#input_motivo_edicion").val() == motivo_edit){
...
/*Function agregar*/
function agregar(){
	var miembro='<input type="text" class="form-control inputivo input_agregar" style="border-radius:0px;margin-top:7px;" name="motivo[]" maxlength="200">';
