    ...
    <form action="Controllers/Controller.Denuncia.php" method="post" name="forminsert" id="forminsert" class="form-inline">
        ...
        <fieldset class="fieldset" style="border-radius:0px;background:#3B5998;">
            ...
            <div class="form-group persona" id="persona" style="display: block;">
                <?php /*<label for="nacionalidad" id="nac" class="buscar">Cédula</label>*/?>
                <label for="nacionalidad" style="margin-left:30px;display:block;font-size:0.8em;float:left;width:150px;">Nacionalidad</label>
                <label for="nacionalidad"  style="display:block;font-size:0.8em;float:left;width:150px;">Cédula</label>
                <div style="clear:both;"></div>
                <select id="nacionalidad" name="nacionalidad" class="form-control" style="width:150px !important;">
                ...
                <div class="form-group elementoform" id="botones_pernat" style="float:right;">
                    <input type="submit" id="boton_consulta" class="btn btn-default" value="Consultar" style="padding:5px;">
        ...
        $(document).ready(function()
        {
            ...
            $("#boton_consulta").click(function(e){
                ...
                if( $("#cedula").val() == '' ){
                    ...
                    $("#mensaje_empresa").dialog({width:"960px",title:"Historial de empleo del ciudadano "+$("#cedula").val(),minHeight:"300px","resizable":false,position: "top"/*,modal:true*/});
                    ...
                    $.ajax({
                        ...
                        type:  'post',
                        beforeSend: function(){
                            $("#mensaje_empresa #empresa_rel").html("<div style='background:white;vertical-align:center;'><img src='<?=$base_url;?>public_html/imagenes/484.GIF' style='background:rgba(255,255,255,0.5);width:70px;height:70px;margin-top:50px;'><br><p style='margin-top:16px;margin-bottom:50px;font-weight:bold;'>Cargando...</p></div>");
                        },
