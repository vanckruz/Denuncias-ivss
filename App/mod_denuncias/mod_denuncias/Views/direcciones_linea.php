		...
		<form action="Controllers/Controller.Direcciones.php" method="post" id="form_agregar_motivo">
			...
			<div id="input_agregador_motivos" style="margin-top:35px;float;left;">
				...
				<div class="inputivo" style="float:left;">
					<input type="text" class="form-control input_agregar" style="border-radius:0px;width:350px;float:left;" name="direccion[]" maxlength="200">	
					<input type="text" class="form-control input_agregar input_correo" style="border-radius:0px;width:350px;margin-left:10px;float:left;" name="correo[]" maxlength="200">		
				</div>
...
<div id="editar_motivo" style="display:none;width:100%;height:100%;position:fixed;top:0px;left:0px;z-index:50;overflow:hidden;">
	...
	<div style="width:70%;margin:auto;height:250px;overflow:hidden;padding:25px;background:#f1f1f1;">
		<form action="Controllers/Controller.Direcciones.php" method="post" id="form_editar_motivo">
			...
			<input type="text" class="form-control" style="border-radius:0px;" name="correo_direccion" id="input_correo">
			<hr>
			<div>
...
/*Function agregar*/
function agregar(){
	var miembro='<div class="inputivo" style="float:left;"><input type="text" class="form-control input_agregar" style="border-radius:0px;width:350px;float:left;" name="direccion[]" maxlength="200">';
	miembro+='<input type="text" class="form-control input_agregar input_correo" style="border-radius:0px;width:350px;margin-left:10px;float:left;" name="correo[]" maxlength="200"></div>';
