...
<body style="background:linear-gradient(to right, #AFA19E, #E7E7FF, #E7E7E7, #8E8E8E) no-repeat scroll 0% 0% #8E8E8E;height:100%;">
    ...
    <div class="content-menu">
        <a href="mod_denuncias/denuncias.responsable.php" id="denuncia" data-content="Módulo para la gestión de denuncias del sistema de fiscalización del ivss" rel="popover" data-placement="right" data-original-title="Gestión de denuncias" data-trigger="hover"> 
         <div class="item-menu">       
    ...
    <a href="mod_denuncias/quejas.responsable.php" id="quejas" data-content="Módulo para la gestión de quejas y reclamos del sistema de fiscalización del ivss" rel="popover" data-placement="right" data-original-title="Gestión de Queja y Reclamos" data-trigger="hover">
        <div class="item-menu">
