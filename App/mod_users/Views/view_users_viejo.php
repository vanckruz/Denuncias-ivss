...
<div id="ModalBoxEdit" style="display:none;width:100%;height:100%;position:fixed;top:0px;left:0;z-index:50;overflow:hidden; background:rgba(0,0,0,0.5)">
   <form name="FormularioEdicion" id="FormularioEdicion" action="Controller.User.php" method="POST" style="margin-top: -20px!important;">
    ...
    <table style="margin:auto;">
        <tr>
            <th colspan="4" style="padding: 0% 0% 2% 0%;background: #F1F1F1;">
                <div class="separador" style="background-color: #F1F1F1;">
        ...
        <tr>
            <td>
                ...
                <input type="text" id="NombreUser" name="NombreUser" class="inputleft"  readonly="" form="ModalForm">
            </td>
            <td>
                <label class="LabelForm">Apellido</label>
                <input id="ApellidoUser" name="ApellidoUser" type="text" class="inputright" readonly="" form="ModalForm">
            </td>
        </tr>
        <tr>
            <td>
                <label class="LabelForm">Cédula</label>
                <input id="Cedula" name="Cedula" type="text" class="inputleft" readonly="" form="ModalForm">
            </td>
            <td>
                <span class="obligatorio">*</span>
                <label id="EmailLabel" class="LabelForm">Correo Electrónico</label>
                <input id="Email" name="Email" type="text" class="inputright" maxlength="100" pattern="^[_a-zA-Z0-9-]+(\.[_a-zA-Z0-9-]+)*@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*(\.[a-zA-Z]{2,3})$" title="ingrese un email válido" form="ModalForm">
            </td>
        </tr>
                <tr>
                    <td>
                        <label class="LabelForm" style="float: left;margin-left: 31px;margin-top: 10px;">Teléfono de Habitación</label>
                        <select name="TelefHabitacionSelect" id="TelefHabitacionSelect" style="width: 96px !important;float: left;margin-top: 5px;" form="ModalForm">
                       ...
                       <input id="Telf_Habitacion" name="Telf_Habitacion" type="text" class="inputleft" onkeypress="return justNumbers(event);" maxlength="7" placeholder="1234567" style="width: 191px !important;"  form="ModalForm">
                   </td>
                   <td>
                    <label style="float: left;margin-left: 53px;margin-top: 10px;" class="LabelForm">Teléfono Móvil</label>
                    <select name="TelefMovilSelect" id="TelefMovilSelect" style="width: 96px !important;float: left;margin-top: 5px;" form="ModalForm">
                        <option value="">Seleccione</option>
                    ...
                    <input id="Telef_Movil" name="Telef_Movil" type="text" class="inputright" onkeypress="return justNumbers(event);" maxlength="7" placeholder="1234567" style="width: 191px !important;" form="ModalForm">
                </td>
            </tr>
        <tr>
            <th colspan="4" style="padding: 0% 0% 2% 0%;background: #F1F1F1;">
                <div class="separador" style="background-color: #F1F1F1;">                    
                    <h2 style="background:#3B5998;color:white;padding:7px;text-align: left;font-size: 1.2em;">Datos del Usuario</h2>
                </div>
            </th>
        </tr>
        <tr>
            <td>
                ...
                <input name="UserName" id="UserName" type="text" class="inputleft" maxlength="100" form="ModalForm">
            </td>
             <td>
                <span class="obligatorio">*</span>
                <label id="PerfilLabel" class="LabelForm">Perfil</label>
                <select id="perfil" name="perfil" class="inputright" form="ModalForm">
        ...
        <tr>           
            <td><span class="obligatorio">*</span><label id="RegionLabel" class="LabelForm">Región</label>
                <select id="regionselect" name="regionselect" class="inputleft" form="ModalForm"> 
                    <option value="">Seleccione</option>
              ...
              <td><span class="obligatorio">*</span><label id="EstadoLabel" class="LabelForm">Estado</label>                
                <select id="estadoselect" name="estadoselect" class="inputright" form="ModalForm"> 
                    <option value="">Seleccione</option>
                        <!--<?
        ...
        <tr>          
            <td>
                ...
                <select id="oficinaselect" name="oficinaselect" class="inputleft" form="ModalForm">
                    <option value="">Seleccione</option>
                </select>
            </td>
             <td>
                ...
                <select id="direcciongeneralselect" name="direcciongeneralselect" class="inputright" form="ModalForm">
                    <option value="">Seleccione</option>
                    <?
            ...
            <tr>               
                <td>
                    ...
                    <select id="direccionlineaselect" name="direccionlineaselect" class="inputleft" form="ModalForm">
                        <option value="">Seleccione</option>
                ...
                <td>
                    ...
                    <select id="divisionselect" name="divisionselect" class="inputright" form="ModalForm">
                        <option value="">Seleccione</option>
            ...
            <tr>
                <td colspan="4" style="text-align: center;">
                    <button style="margin-bottom:10px;float:right;" id="CancelUpdate"  type="button"  class="btn btn-danger">
                        <span class="glyphicon"></span> Regresar
                    </button>
                    <button style="margin-bottom:10px;float:right; margin-right: 1%;" id="AceptarUpdate" type="button"  class="btn btn-primary">
