...
<style>
    ...
    #animacion_ivss:hover{
        ...
        cursor:url("<?=$base_url;?>public_html/imagenes/ivss_logo_cursor.png"),auto;
    }
</style>
<body style="background:linear-gradient(to right, #AFA19E, #E7E7FF, #E7E7E7, #8E8E8E) no-repeat scroll 0% 0% #8E8E8E;height:100%;">

    <div class="content-menu">
        <a href="mod_denuncias/denuncias.php" id="denuncia" data-content="Módulo para la gestión de denuncias del sistema de fiscalización del ivss" rel="popover" data-placement="right" data-original-title="Gestión de denuncias" data-trigger="hover"> 
         <div class="item-menu">       
    ...
    <a href="mod_denuncias/quejas.php" id="quejas" data-content="Módulo para la gestión de quejas y reclamos del sistema de fiscalización del ivss" rel="popover" data-placement="right" data-original-title="Gestión de Queja y Reclamos" data-trigger="hover">
        <div class="item-menu">
...
<?php /*
    <a href="mod_fiscalizacion/fiscalizacion.php" id="fiscalizacion" data-content="Módulo para la gestión de fiscalización de empresas" rel="popover" data-placement="right" data-original-title="Gestión de Fiscalización" data-trigger="hover">
        <div class="item-menu">
            <img src="<?=$base_url;?>public_html/imagenes/iconos/fiscalizacion1.png" class="img_menu" />    
            <p>Fiscalización</p>
        </div>
    </a>
    */ ?>
...
<?php /*
    <a href="mod_oficinas/oficinas.php" id="oficinas" data-content="Módulo para la gestión de oficinas administrativas del ivss" rel="popover" data-placement="right" data-original-title="Gestión de Oficinas Administrativas" data-trigger="hover">
        <div class="item-menu">       
            <img src="<?=$base_url;?>public_html/imagenes/iconos/oficinas1.png" class="img_menu" />
            <p>Oficinas</p>
        </div>
    </a>
*/ ?>
...
<a href="mod_users/users.php" id="users" data-content="Módulo para la gestión de usuarios del sistema de fiscalización del ivss" rel="popover" data-placement="right" data-original-title="Gestión de usuarios" data-trigger="hover">
    <div class="item-menu">         
        <img src="<?=$base_url;?>public_html/imagenes/iconos/usuarios.png" class="img_menu" />
        <p>Usuarios</p>
    </div>
</a>
