...
$empresas = dameEmpresasCompletas();
...
<body>
	<div style="width:100%;background:white;min-height:600px;padding:25px;margin-bottom:75px;"><!--Content-->
		<div style="font-size:1.1em;color:#333;background:#3B5998;padding:5px;color:white;margin-bottom:12px;"><div style="width:50px;border:1px solid white;float:left;cursor:pointer;"><input type="checkbox" id="sel_all_denuncias"> <span class="glyphicon glyphicon-ok" style="color:white;font-size:0.7em;"></span></div>Empresas</div>
		<form action="../mod_denuncias/Controllers/Controller_Denuncia_Correo.php " method="post" id="form_denuncias">
			...
			<tbody class="tbody_list_den">
				...
				<?php if(empty($denuncias)){echo "";} else {foreach ($empresas as $empresa) { ?>
				<tr>
					<td><input type="checkbox" class="check_denuncias" name="denuncia_true[]" form="form_denuncias" value="<?=$empresa['ID_EMPRESA'];?>" style="cursor:pointer;"></td>
					<td><?=$empresa['ID_EMPRESA'];?></td>
					<td><?=$empresa['NOMBRE_EMPRESA'];?></td>
						<?php /* 
						<td style="width:100px;"><?=$empresa['ID_EMPRESA'];?></td>
						<td>
