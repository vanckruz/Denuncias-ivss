        ...
        <div class="principal">
            <div class="login" style="  height: 433px;">
                ...
                <div id="div_user" style="overflow:hidden; width: 600px;">
                    ...
                    <form name="form_cambiar_contrasena" id="form_cambiar_contrasena" method="post" action="App/mod_users/Controllers/Controller_contraseña.php">
                        <table>                          
                            <tr>
                                <!--Cedula Usuario-->
                                <td style="width:500px;font-size:1.2em;">Cédula: </td>
                                 <td> 
                                    <div class="inner-addon left-addon" style="margin-top:5px;">
                                        ...
                                        <input style="  width: 329px;" type="text" name="cedula" id="cedula" class="form-control" maxlength="8">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width:500px;font-size:1.2em;">Nueva contraseña: </td>
                                 <td>
                                    <div class="inner-addon left-addon" style="margin-top:5px;">
                                        ...
                                        <input style="  width: 329px;" type="password" name="newpassword" id="newpassword" class="form-control" maxlength="50" title="Repita su contraseña anterior" />
                                    </div>
                                </td>
                        </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="inner-addon left-addon" style="margin-top:5px;">
                                        <i class="glyphicon glyphicon-asterisk"></i>
                                        <input style="  width: 329px;" type="password" name="repeatnewpassword" id="repeatnewpassword" class="form-control" maxlength="50" title="Ingrese una contraseña válida"/>
                                    </div>
                                </td>
                            </tr>                            
                        </table>
                    ...
                    <button id="ingresobutton" name="ingresobutton" type="submit" style="height: 35px;" class="btn btn-default btn-volver" id="btn-volver">
                        <span style="margin-top: -5px;" class="glyphicon">Guardar</span>
                    </button>
                    <button type="reset" style="height: 35px; margin-right: 130px;" class="btn btn-default btn-volver" id="btn-volver">
                        <span style="margin-top: -5px;" class="glyphicon"> Limpiar</span>
                    </button>
                    <button type="button" style="height: 35px; background-color: transparent; border-color: transparent;" class="btn btn-default btn-volver" id="btn-volver" onclick="window.history.back();" title="Volver">
                        <span style="margin-top: -5px;" class="glyphicon glyphicon-arrow-left"></span>
                    </button>                    
                    </div>
                    </form>
                </div><!--Div user-->                
