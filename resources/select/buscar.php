...
if(isset($_POST['nac_apo']) && isset($_POST['id_apo']))
{
	...
	if ($ciudadano == ""){
		...
		$respuesta = array("nombre"=>$nombre, "apellido"=>$apellido, "prinom"=>$prinom,"segnom"=>$segnom,"priape"=>$priape,"segape"=>$segape,"telhab"=>$telhab,"telmov"=>$telmov,'email'=>$email,'id_ciudadano'=>$id_ciudadano);
	}
...
if(isset($_POST['estado']))
{
	...
	$html = "<option value='' style='padding:5px;'>Seleccione</option>";   
	foreach($municipios as $indice => $registro)
	{
		$html .= "<option style='padding:5px;' data-municipio='".$registro['NOMBRE_MUNICIPIO']."' value='".$registro['ID_MUNICIPIO']."'>".$registro['NOMBRE_MUNICIPIO']."</option>";
	}
...
if(isset($_POST['municipio']))
{
	...
	{
		$html .= "<option style='padding:5px;' data-parroquia='".$registro['DESC_PARROQUIA']."' value='".$registro['ID_PARROQUIA']."'>".$registro['DESC_PARROQUIA']."</option>";
	}
...
if(isset($_POST['direccionlinea'])){

	$id_direccionlinea 	= $_POST['direccionlinea'];
	$direcioneslinea	= dameDivisiones($id_direccionlinea);
	$html = "<option style= 'padding:5px;' value=''>Seleccione</option>";
