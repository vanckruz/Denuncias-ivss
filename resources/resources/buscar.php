...
if(isset($_POST['region']))
{
	...
	{
		$html .= "<option value='".$registro['INICIAL_NUMERO_EMPRESA']."'>".$registro['NOMBRE_ESTADO']."</option>";
	}
...
if(isset($_POST['nac_apo']) && isset($_POST['id_apo']))
{
	...
	if ($ciudadano == ""){
		...
		$int_borrado 	= $usuario[0]['INT_BORRADO'];
		$respuesta = array("nombre"=>$nombre, "apellido"=>$apellido, "prinom"=>$prinom,"segnom"=>$segnom,"priape"=>$priape,"segape"=>$segape,"telhab"=>$telhab,"telmov"=>$telmov,'email'=>$email,'usuario'=>$usuario,'id_ciudadano'=>$id_ciudadano",int_borrado"=>$int_borrado);
	}
...
if(isset($_POST['estado']))
{
	...
	{
		$html .= "<option value='".$registro['ID_MUNICIPIO']."'>".$registro['NOMBRE_MUNICIPIO']."</option>";
	}
...
if(isset($_POST['municipio']))
{
	...
	{
		$html .= "<option value='".$registro['ID_PARROQUIA']."'>".$registro['DESC_PARROQUIA']."</option>";
	}
